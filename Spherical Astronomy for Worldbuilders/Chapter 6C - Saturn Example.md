### Saturn in the Sky
We figured out how Venus looked in examples $4.1$ and $6.10$. Let's do something more detailed: Let's figure out how Saturn looked in the sky on $\text{January 1, } 2024$ at $19:00$ from London, UK ($\phi = +51\degree, l = 0\degree$).
...
\end{align}
```
Note that these values differ slightly from examples $4.1$ and $6.10$ because we used a different data set. (Why do different data sets differ on the same quantities? I do not know.)
...
\end{align}
```
Now we follow example $6.10$ except we use the Celestial North pole instead of the Sun.\
