## 10. Lunar Eclipses
Lunar eclipses happen when the Earth casts a shadow on the Moon. As it is a phenomenon that really changes the appearance of the Moon, anywhere on the Earth that can see the Moon during a lunar eclipse will see it, unlike solar eclipses. This makes the discussion of lunar eclipses much simpler than the discussion of solar eclipses. We follow We follow Chauvenet (1891) and Seidelmann (1992).
...
\tau_{P1} &=  \frac{0.02737643\cos(2.45042966) - 0.01763229\cos(2.49326968 - 1.06613342)}{0.01038443}\\
&= -2.2743698\\
T_{P1} &= 03:00:00 -2.2743698h = 00:43:32\\
\\
\therefore \psi_{P4} &= \arcsin(0.6374337) = 0.69116299\\
\tau_{P4} &=  \frac{0.02737643\cos(0.69116299) - 0.01763229\cos(2.49326968 - 1.06613342)}{0.01038443}\\
&= 1.78818948\\
T_{P4} &= 03:00:00 + 1.78818948h = 04:47:17
\end{align}
```
...
\tau_{U1} &=  \frac{0.01811581\cos(1.84261887) - 0.01763229\cos(2.49326968 - 1.06613342)}{0.01038443}\\
&= -0.71147116\\
T_{U1} &= 03:00:00 -0.71147116h = 02:17:19\\
\\
\therefore \psi_{U4} &= \arcsin(0.96328317) = 1.29897378\\
\tau_{U4} &=  \frac{0.01811581\cos(1.29897378) - 0.01763229\cos(2.49326968 - 1.06613342)}{0.01038443}\\
&= 0.22529084\\
T_{U4} &= 03:00:00 + 0.22529084h = 03:13:31
\end{align}
```
...
```
Using $L = L_1 = 0.02737643$ in equation $10.9$, the penumbral magnitude is:
```math
\text{Penumbral Magnitude } = \frac{0.02737643 - 0.01763229}{2 \cdot 0.00486029} = 1.0024
```
Using $L = L_3 = 0.01811581$ in equation $10.9$, the umbral magnitude is:
```math
