...
\end{align}
```
More repetition will improve our estimations even further, but they rapidly converge. (A third estimate using $\lambda_{\text{Sun}} = 217\degree\enspace17'\enspace20.13''$ gives the time $11:48:44$.)
