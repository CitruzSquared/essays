...
\end{align}
```
These formulae are not exact as they ignore small terms involving $e_M^2$, $e_P^2$, $i^2$, and $a_M/a_P$ (not ignoring these would make the formulae even more complicated). Thus, for the formula to work best, these parameters for the Moon - Planet system **must be small**.
...
\end{align}
```
Which are all very small, so equations $42$ and $43$ will work.\
