...
```
Equation $9.50$ is known as the *second fundamental equation of eclipse theory*. Note that the approximations $id' = 0$, $i^2 = 0$, and $\zeta = \zeta_1$ may be made here, but for accuracy's sake we will keep the whole expression.
