...
```
Equation $9.50$ is known as the *second fundamental equation of eclipse theory*. Note that the approximations $id' = 0$ and $i^2 + 1 = 1$ may be made here without much significant loss of precision (in most reasonable cases), which gives:
```math
...
\end{align}
```
And $\zeta$ can also be substituted for $\zeta_1$ in either equation $9.50$ or $9.51*$ if wanted.
