...
Given that, for the Moon, on $\text{July 22, } 2024$, at $00:00$ UTC, the mean longitude was $L' = 310\degree$ $29'$, the ecliptic coordinates were $\lambda = 307\degree$ $21'$ and $\beta = -4\degree$ $27'$, and the longitude of the ascending node was $\Omega = 8\degree$ $47'$, find the libration angles $l$, $b$, and $c$. <br/>
