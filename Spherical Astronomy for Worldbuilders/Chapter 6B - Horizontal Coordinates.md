...
\end{align}
```
Thus, we rotate Venus by $133\degree$ $3'$ $31.3''$ from the Zenith. Keeping in mind that since the Sun's azimuth is less than that of Venus (i.e. the Sun West of Venus), the Sun must be shining from the left:
<p align="center">
...
<p align="center">
  ...
  Stellarium on the left, Stellarium overlaid with our prediction on the right.
</p>
