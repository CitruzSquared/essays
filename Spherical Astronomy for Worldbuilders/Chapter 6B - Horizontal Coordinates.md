...
\end{align}
```
Thus the longitude of the Sun should be $121\degree$ $7'$ ($3''$ ignored just for brevity) if it were to rise at the same time as Sirius.\
...
And thus:
```math
\tan(\Theta_L) = \cos(\varepsilon)\tan(\lambda)
```
...
<td align="center">
<img width="2000" height="0"><br>
Find the subsolar point if $\lambda_{\text{Sun}} = 66\degree$ $40'$ and $\Theta = 24\degree$ $55'$ $27''$. <br/>
...
<td align="center">
<img width="2000" height="0"><br>
Find the $\lambda$ values of the Sun for which there is Lahaina noon in Mecca, Saudi Arabia. ($\phi = 21\degree$ $25'$ $25''$).
<img width="2000" height="0">
</td>
</tbody>
</table>
