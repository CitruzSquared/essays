...
\end{array}
```
As we can see, $E$ has quickly converged onto $76\degree\enspace7'\enspace19.176''$. We can now calculate $(x, y)$ with equation $19$:
```math
\begin{align}
x &= a \cos (E) - ae\\
...
```math
\lambda_{\text{Heliocentric}} \text{ of the Earth} = 180\deg.
```
